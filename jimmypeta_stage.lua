...
function jimmypeta_stage:leave()
    -- Limpar callbacks de input
    input:clear_callbacks()
end

function jimmypeta_stage:update(dt)
    -- Atualizar sistema de input
    input:update(dt)
end

function jimmypeta_stage:draw()
...
-- Configurar callbacks de input
function jimmypeta_stage:setup_input_callbacks()
...
function jimmypeta_stage:keypressed(key)
    input:keypressed(key)
end

function jimmypeta_stage:joystickpressed(joystick, button)
    input:joystickpressed(joystick, button)
end

function jimmypeta_stage:gamepadpressed(gamepad, button)
    input:gamepadpressed(gamepad, button)
end

function jimmypeta_stage:mousepressed(x, y, button)
    input:mousepressed(x, y, button)
end

return jimmypeta_stage
